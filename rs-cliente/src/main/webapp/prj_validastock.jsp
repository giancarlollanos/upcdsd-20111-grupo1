		...
		$("#btnConsultar").click(function() {
			$.ajax({
				...
				success: function(data) {
					if(data >= $("#consultar_cantidadlibro").val())
					{						
						//location.href='prj_transaccion.jsp';
						document.location.href='prj_transaccion.jsp';//?login='+strLogin+'&codlib='+$("#consultar_codigolibro").val();
					}
					else
					{
...
<table cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td>Cantidad</td>
		<td><input id="consultar_cantidadlibro" type="text" width=20px /></td>
	</tr>
</table>
<input type="button" id="btnConsultar" value="Consultar" width=10px />
<span id="span1"></span>
